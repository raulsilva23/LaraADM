    ...
    <div class="container">
        <div class="row centered">
            ...
            <div class="col-lg-12">
                ...
                <h3><a href="{{ url('/login') }}" class="btn btn-lg btn-success">Crie um Perfil</a></h3><br>
            </div>
          <!--
            <div class="col-lg-2">
...
<div id="intro">
    <div class="container">
        <div class="row centered">
            <h1>Gestão na Engenharia</h1>
            <br>
            <br>
            <div class="col-lg-4">
                <i class="fa fa-cubes" style="font-size:100px;height:110px;"></i>
                <h3>Modular</h3>
                <p>Criação simples de módulos.</p>
            </div>
            <div class="col-lg-4">
                <i class="fa fa-paper-plane" style="font-size:100px;height:110px;"></i>
                <h3>Facil Instalação</h3>
                <p>Com simples comandos.</p>
            </div>
            <div class="col-lg-4">
                <i class="fa fa-cubes" style="font-size:100px;height:110px;"></i>
                <h3>Costumizavel</h3>
                <p>Facil de manipular dados.</p>
            </div>
        </div>
        <br>
        <hr>
...
<div id="c">
    <div class="container">
        <p>
            <strong>Copyright &copy; 2018. Powered by <a href="https://dwijitsolutions.com"><b>FGR</b></a>
        </p>
    </div>
</div>
